...
/* ---------- THE WEST QUAY AND ITS POOL — REMOVED (city v173) --------------------------------
   `maryahPromenade` is gone. It reclaimed Al Maryah's west quay out to a hand-traced basin and
   drew a pool, a sea wall, a walk and a restaurant frontage on it, because the baked outline
   through that stretch is a straight chord that cuts inside the real shore and left the built
   waterfront standing in the sea.

   That was a workaround for a wrong outline, not a description of the island, and the owner has
   asked for it out. The land it stood in for is being restored where it belongs — in the bake,
   in the island's own coastline — so anything drawn here would be reclamation on top of
   reclamation. The kit map and the instantiation list in w2h-world.js drop it with this. */
