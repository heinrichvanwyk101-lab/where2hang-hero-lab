...
export const BUILD = 'basemap v30';
...
export const DIORAMA = {
  ...
  zayed:    [ 1584,   761 ],
  /* THE EASTERN FOUR MOVED 400 EAST (basemap v29, 370; v30, 400 once the island widened west for Etihad Plaza: 37 units clear of Zayed City, was 16). Yas, Al Raha, Masdar and the airport sat 733
     ...
     outlines: the island clears Zayed City by 37 units and Al Raha's own strip clears Rabdan by
     66 (it overlapped Rabdan between 200 and 300, and was 13 clear at 0). The owner chose the
     minimum over true position: "keep the diorama as compact as possible". The four keep their
     mutual geometry exactly; they are still 333 units west of true. */
  masdar:   [ 2574,   542 ],
  airport:  [ 2926,   272 ],
};
